...
// Source: github.com/lovoo/goka/storage (interfaces: Storage,Cleanable)
...
// Close mocks base method
func (m *MockCleanable) Close() error {
	ret := m.ctrl.Call(m, "Close")
	ret0, _ := ret[0].(error)
	return ret0
}
...
// Close indicates an expected call of Close
func (mr *MockCleanableMockRecorder) Close() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockCleanable)(nil).Close))
}

// Delete mocks base method
func (m *MockCleanable) Delete(arg0 string) error {
	ret := m.ctrl.Call(m, "Delete", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// Delete indicates an expected call of Delete
func (mr *MockCleanableMockRecorder) Delete(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockCleanable)(nil).Delete), arg0)
}

// DeleteUntil mocks base method
func (m *MockCleanable) DeleteUntil(arg0 context.Context, arg1 int64) (int64, error) {
...
func (mr *MockCleanableMockRecorder) DeleteUntil(arg0, arg1 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteUntil", reflect.TypeOf((*MockCleanable)(nil).DeleteUntil), arg0, arg1)
}

// Get mocks base method
func (m *MockCleanable) Get(arg0 string) ([]byte, error) {
	ret := m.ctrl.Call(m, "Get", arg0)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
...
// Get indicates an expected call of Get
func (mr *MockCleanableMockRecorder) Get(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockCleanable)(nil).Get), arg0)
}

// GetOffset mocks base method
func (m *MockCleanable) GetOffset(arg0 int64) (int64, error) {
	ret := m.ctrl.Call(m, "GetOffset", arg0)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
...
// GetOffset indicates an expected call of GetOffset
func (mr *MockCleanableMockRecorder) GetOffset(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOffset", reflect.TypeOf((*MockCleanable)(nil).GetOffset), arg0)
}

// Has mocks base method
func (m *MockCleanable) Has(arg0 string) (bool, error) {
	ret := m.ctrl.Call(m, "Has", arg0)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
...
// Has indicates an expected call of Has
func (mr *MockCleanableMockRecorder) Has(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Has", reflect.TypeOf((*MockCleanable)(nil).Has), arg0)
}

// Iterator mocks base method
func (m *MockCleanable) Iterator(arg0, arg1 []byte) storage.Iterator {
	ret := m.ctrl.Call(m, "Iterator", arg0, arg1)
	ret0, _ := ret[0].(storage.Iterator)
	return ret0
}
...
// Iterator indicates an expected call of Iterator
func (mr *MockCleanableMockRecorder) Iterator(arg0, arg1 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Iterator", reflect.TypeOf((*MockCleanable)(nil).Iterator), arg0, arg1)
}

// MarkRecovered mocks base method
func (m *MockCleanable) MarkRecovered() error {
	ret := m.ctrl.Call(m, "MarkRecovered")
	ret0, _ := ret[0].(error)
	return ret0
}
...
// MarkRecovered indicates an expected call of MarkRecovered
func (mr *MockCleanableMockRecorder) MarkRecovered() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MarkRecovered", reflect.TypeOf((*MockCleanable)(nil).MarkRecovered))
}

// Open mocks base method
func (m *MockCleanable) Open() error {
	ret := m.ctrl.Call(m, "Open")
	ret0, _ := ret[0].(error)
	return ret0
}
...
// Open indicates an expected call of Open
func (mr *MockCleanableMockRecorder) Open() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Open", reflect.TypeOf((*MockCleanable)(nil).Open))
}

// Set mocks base method
func (m *MockCleanable) Set(arg0 string, arg1 []byte, arg2 int64) error {
	ret := m.ctrl.Call(m, "Set", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// Set indicates an expected call of Set
func (mr *MockCleanableMockRecorder) Set(arg0, arg1, arg2 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Set", reflect.TypeOf((*MockCleanable)(nil).Set), arg0, arg1, arg2)
}

// SetOffset mocks base method
func (m *MockCleanable) SetOffset(arg0 int64) error {
	ret := m.ctrl.Call(m, "SetOffset", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// SetOffset indicates an expected call of SetOffset
func (mr *MockCleanableMockRecorder) SetOffset(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetOffset", reflect.TypeOf((*MockCleanable)(nil).SetOffset), arg0)
}
